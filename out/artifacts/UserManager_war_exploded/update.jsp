          ...
          <div class="form-group">
            <label for="address">籍贯：</label>
             <select name="address" id="address" class="form-control" >
                 <c:if test="${user.address == '羊村'}">
                    <option value="羊村" selected>羊村</option>
                    <option value="狼堡">狼堡</option>
                    <option value="实验室">实验室</option>
                     <option value="狗熊岭">狗熊岭</option>
                     <option value="湖泊">湖泊</option>
                     <option value="树洞">树洞</option>
                 </c:if>

                 <c:if test="${user.address == '狼堡'}">
                     <option value="羊村" >羊村</option>
                     <option value="狼堡" >狼堡</option>
                     <option value="实验室">实验室</option>
                     <option value="狗熊岭">狗熊岭</option>
                     <option value="湖泊">湖泊</option>
